...
# Dump of table rat_admin_log
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_admin_log`;

CREATE TABLE `rat_admin_log` (
...
# Dump of table rat_area
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_area`;

CREATE TABLE `rat_area` (
...
# Dump of table rat_article
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_article`;

CREATE TABLE `rat_article` (
...
# Dump of table rat_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_category`;

CREATE TABLE `rat_category` (
...
# Dump of table rat_configs
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_configs`;

CREATE TABLE `rat_configs` (
...
# Dump of table rat_dept
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_dept`;

CREATE TABLE `rat_dept` (
...
# Dump of table rat_dict_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_dict_data`;

CREATE TABLE `rat_dict_data` (
...
# Dump of table rat_dict_type
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_dict_type`;

CREATE TABLE `rat_dict_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
# Dump of table rat_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_menu`;

CREATE TABLE `rat_menu` (
...
# Dump of table rat_post
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_post`;

CREATE TABLE `rat_post` (
...
# Dump of table rat_role
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_role`;

CREATE TABLE `rat_role` (
...
# Dump of table rat_role_dept
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_role_dept`;

CREATE TABLE `rat_role_dept` (
...
# Dump of table rat_role_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_role_menu`;

CREATE TABLE `rat_role_menu` (
  `role_id` int(11) NOT NULL COMMENT '角色ID',
...
# Dump of table rat_user_post
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_user_post`;

CREATE TABLE `rat_user_post` (
...
# Dump of table rat_user_role
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rat_user_role`;

CREATE TABLE `rat_user_role` (
  `user_id` int(11) NOT NULL COMMENT '用户ID',
  `role_id` int(11) NOT NULL COMMENT '角色ID',
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
